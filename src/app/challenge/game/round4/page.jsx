...
export default function page() {
  return (
    <div className="flex justify-center items-center gap-15">
            ...
            <div>
                <div className="flex justify-center items-center w-[60vw]">
                    <div className="bg-green-600 w-[40%] h-[20px]"></div>
                        <Image src={"/head.png"} width={50} height={50} className='absolute left-[34%]'></Image>
                    <div className="bg-gray-200 w-[60%] h-[20px]"></div>
                        <Image src={"/bufhead.png"} width={60} height={60} className='absolute left-[70%]'></Image>
                </div>
            </div>
            <Image src={"/hcal.png"} width={400} height={150} className='w-[30vw]'></Image>
            <div className="flex justify-center items-center gap-10">
                <div className="border-2 border-green-600 p-3 rounded-2xl h-70 flex items-center">
                    <Image src={"/ex3.png"} width={500} height={150}></Image>
                </div>
        ...
        <Link href={"/challenge/game/round5"}><GrLinkNext style={{color:"black",width:"70px",height:"70px",position:"absolute",bottom:"120px",right:"280px",cursor:"pointer",zIndex:"999"}} /></Link>
        <Image src={"/bcal.png"} width={250} height={450}></Image>
    </div>
  )
}
