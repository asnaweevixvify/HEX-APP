...
export default function page() {
  return (
    <div className="flex flex-col h-[100vh] justify-center items-center gap-[80px]">
        ...
        <Link href={"/challenge/game/round4"}><GrLinkNext style={{color:"black",width:"70px",height:"70px",position:"absolute",bottom:"120px",right:"280px",cursor:"pointer",zIndex:"999"}} /></Link>
